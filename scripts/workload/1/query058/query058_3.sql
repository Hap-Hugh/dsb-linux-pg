 ...
 where ss_item_sk = i_item_sk
   and d_date in (select d_date
                  ...
                  where d_month_seq = (select d_month_seq
                                      from date_dim
                                      where d_date = '2001-03-20'))
   and ss_sold_date_sk   = d_date_sk
   and ss_list_price between 192 and 221
   and i_manager_id BETWEEN 23 and 52
...
group by i_item_id, c_birth_year),
 ...
 where cs_item_sk = i_item_sk
  ...
  and  cs_list_price between 192 and 221
  and i_manager_id BETWEEN 23 and 52
...
group by i_item_id, c_birth_year),
 ...
 where ws_item_sk = i_item_sk
  ...
  and ws_list_price between 192 and 221
  and i_manager_id BETWEEN 23 and 52
