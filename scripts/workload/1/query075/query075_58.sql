...
WITH all_sales AS (
 ...
 FROM (SELECT d_year
       ...
       and cr_reason_sk in (8, 16, 18, 30, 40)
       UNION
       SELECT d_year
             ,i_brand_id
             ,i_class_id
       ...
       and sr_reason_sk in (8, 16, 18, 30, 40)
       UNION
       SELECT d_year
             ,i_brand_id
             ,i_class_id
       ...
       WHERE i_category='Electronics'
       and ws_sales_price / ws_list_price BETWEEN 74 * 0.01 AND 94 * 0.01
       and wr_reason_sk in (8, 16, 18, 30, 40)) sales_detail
