...
WITH all_sales AS (
 ...
 FROM (SELECT d_year
       ...
       and cr_reason_sk in (10, 11, 20, 46, 69)
       UNION
       SELECT d_year
             ,i_brand_id
             ,i_class_id
       ...
       and sr_reason_sk in (10, 11, 20, 46, 69)
       UNION
       SELECT d_year
             ,i_brand_id
             ,i_class_id
       ...
       WHERE i_category='Sports'
       and ws_sales_price / ws_list_price BETWEEN 31 * 0.01 AND 51 * 0.01
       and wr_reason_sk in (10, 11, 20, 46, 69)) sales_detail
