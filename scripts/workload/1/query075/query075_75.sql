...
WITH all_sales AS (
 ...
 FROM (SELECT d_year
       ...
       and cr_reason_sk in (14, 26, 36, 70, 74)
       UNION
       SELECT d_year
             ,i_brand_id
             ,i_class_id
       ...
       and sr_reason_sk in (14, 26, 36, 70, 74)
       UNION
       SELECT d_year
             ,i_brand_id
             ,i_class_id
       ...
       WHERE i_category='Home'
       and ws_sales_price / ws_list_price BETWEEN 77 * 0.01 AND 97 * 0.01
       and wr_reason_sk in (14, 26, 36, 70, 74)) sales_detail
