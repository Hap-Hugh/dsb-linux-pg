...
select 
 ...
 where
  ...
  ca_county in ('Essex County','Paulding County','Tuolumne County','Washington County','Wilkinson County') and
  c.c_birth_month in (2, 6) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('W', 'W', 'D')
  and cd_education_status in ('Primary', '2 yr Degree', 'Advanced Degree')
  and cd_gender = 'F' and
  exists (select *
