...
select 
 ...
 where
  ...
  ca_county in ('Delta County','Dodge County','Jackson County','Lyon County','Shannon County') and
  c.c_birth_month in (5, 9) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('W', 'M', 'W')
  and cd_education_status in ('Advanced Degree', '4 yr Degree', 'College')
  and cd_gender = 'F' and
  exists (select *
