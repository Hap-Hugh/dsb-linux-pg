...
select 
 ...
 where
  ...
  ca_county in ('Columbia County','Massac County','Schuyler County','Stark County','Talbot County') and
  c.c_birth_month in (6, 11) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('W', 'D', 'W')
  and cd_education_status in ('Advanced Degree', 'Advanced Degree', '4 yr Degree')
  and cd_gender = 'F' and
  exists (select *
