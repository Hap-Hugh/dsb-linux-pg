...
select 
 ...
 where
  ...
  ca_county in ('Clark County','Greenwood County','Morgan County','Owen County','Pecos County') and
  c.c_birth_month in (3, 9) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('W', 'M', 'D')
  and cd_education_status in ('Advanced Degree', 'Primary', 'Unknown')
  and cd_gender = 'F' and
  exists (select *
