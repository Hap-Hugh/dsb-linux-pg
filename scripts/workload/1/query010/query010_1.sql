...
select 
 ...
 where
  ...
  ca_county in ('Columbia County','Logan County','Monroe County','Oliver County','Scotland County') and
  c.c_birth_month in (4, 9) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('W', 'D', 'S')
  and cd_education_status in ('Advanced Degree', '4 yr Degree', 'Primary')
  and cd_gender = 'F' and
  exists (select *
