...
select 
 ...
 where
  ...
  ca_county in ('Carbon County','Galveston County','Nye County','Penobscot County','Sheridan County') and
  ...
  exists (select *
   ...
   (exists (select *
            ...
            where c.c_customer_sk = ws_bill_customer_sk and
                  ...
                  i_category in ('Books', 'Children', 'Women')
                  and i_manager_id BETWEEN 43 and 52
                  and ws_sales_price / ws_list_price BETWEEN 41 * 0.01 AND 51 * 0.01
                  ) or
    exists (select *
            ...
            where c.c_customer_sk = cs_ship_customer_sk and
                  ...
                  i_category in ('Books', 'Children', 'Women')
                  and i_manager_id BETWEEN 43 and 52
                  and cs_sales_price / cs_list_price BETWEEN 41 * 0.01 AND 51 * 0.01
                  ))
 group by cd_gender,
          cd_marital_status,
          cd_education_status,
