...
with frequent_ss_items as
 (select substring(i_item_desc,1,30) itemdesc,i_item_sk item_sk,d_date solddate,count(*) cnt
  ...
  where ss_sold_date_sk = d_date_sk
    ...
    and d_year = 1998
    and i_manager_id BETWEEN 60 and 79
 ...
 (select max(csales) tpcds_cmax
  from (select c_customer_sk,sum(ss_quantity*ss_sales_price) csales
        ...
        where ss_customer_sk = c_customer_sk
         ...
         and d_year = 1998
         and ss_wholesale_cost BETWEEN 42 AND 52
...
from
 ...
 from (select cs_quantity*cs_list_price sales
       ...
       where d_year = 1998
         ...
         and cs_wholesale_cost BETWEEN 42 AND 52
      union all
      select ws_quantity*ws_list_price sales
       ...
       where d_year = 1998
         ...
         and ws_wholesale_cost BETWEEN 42 AND 52) tmp2
 limit 100;
