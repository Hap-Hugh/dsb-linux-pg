...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2002-02-23','2002-05-24','2002-08-01','2002-11-17')))
 ...
 and sr_reason_sk in (4, 5, 21, 33, 73)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (4, 5, 21, 33, 73)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (4, 5, 21, 33, 73)
 group by i_item_id)
