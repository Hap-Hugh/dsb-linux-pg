...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('1999-03-13','1999-06-12','1999-09-16','1999-11-15')))
 ...
 and sr_reason_sk in (17, 18, 25, 64, 69)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (17, 18, 25, 64, 69)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (17, 18, 25, 64, 69)
 group by i_item_id)
