...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('1998-02-04','1998-05-04','1998-09-16','1998-11-16')))
 ...
 and sr_reason_sk in (1, 17, 21, 22, 54)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (1, 17, 21, 22, 54)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (1, 17, 21, 22, 54)
 group by i_item_id)
