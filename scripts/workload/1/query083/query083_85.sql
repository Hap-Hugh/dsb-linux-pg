...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('1999-02-19','1999-06-21','1999-07-10','1999-10-27')))
 and   sr_returned_date_sk   = d_date_sk
 and i_category IN ('Children', 'Home')
 and i_manager_id BETWEEN 38 and 47
 and sr_return_amt / sr_return_quantity between 271 and 300
 and sr_reason_sk in (7, 28, 38, 42, 59)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (7, 28, 38, 42, 59)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (7, 28, 38, 42, 59)
 group by i_item_id)
