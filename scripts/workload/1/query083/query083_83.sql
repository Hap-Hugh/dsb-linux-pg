...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('1998-01-20','1998-06-05','1998-07-11','1998-11-10')))
 ...
 and sr_reason_sk in (10, 17, 36, 45, 73)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (10, 17, 36, 45, 73)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (10, 17, 36, 45, 73)
 group by i_item_id)
