...
and item1.i_category in ('Books', 'Electronics')
and item2.i_manager_id between 63 and 82
and cd_marital_status = 'M'
and cd_education_status = 'Advanced Degree'
and s1.ss_list_price between 111 and 125
and s2.ss_list_price between 111 and 125
;
